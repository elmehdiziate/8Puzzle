...
if __name__ == '__main__':
    ...
    with open(filename1, mode='r')as file:#read the file
        ...
        for lines in csvReader:
            ...
            print("H1")
            results = searchN.aStarSearch(problem, searchN.H1)# search the problem with the heuristic H1
            ...
            print("H2")
            results = searchN.aStarSearch(problem, searchN.H2)# search the problem with the heuristic H2
            ...
            print("H3")
            results = searchN.aStarSearch(problem, searchN.H3)# search the problem with the heuristic H3
            ...
            print("H4")
            results = searchN.aStarSearch(problem, searchN.H4)# search the problem with the heuristic H4
    ...
    with open("resultsN.csv", mode='w', newline='') as results_file:#write the results to a csv file
